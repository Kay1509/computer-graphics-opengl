...
Object3D *obj;
Point3 *facenormals;
int i,j,l,m,n,count=0,flag=0,N ,M,random1 = 54 ;
Vector3 p,q,r,a,b;
...
static GLfloat LightPos[4],LightPos1[4],LightPos2[4];
...
void myInitGL (void) {
    GLfloat light_ambient[] = {0.5,0.1,0.1, 1.0};
    GLfloat light_diffuse[] = {1.0,1.0,1.0, 1.0};
    GLfloat light_specular[] = {1.0,1.0,1.0, 1.0};

    GLfloat light_ambient1[] = {0.1,0.5,0.1, 1.0};
    GLfloat light_diffuse1[] = {1.0,1.0,1.0, 1.0};
    GLfloat light_specular1[] = {1.0,1.0,1.0, 1.0};
    

    GLfloat light_ambient2[] = {0.1,0.1,0.5, 1.0};
    ...
    LightPos1[0] =  0.0;    LightPos1[1] = 1.0;
    LightPos1[2] =  0.3;    LightPos1[3] = 1.0;
    glLightfv(GL_LIGHT1, GL_POSITION, LightPos1);

    glLightfv(GL_LIGHT2, GL_AMBIENT, light_ambient2);
    glLightfv(GL_LIGHT2, GL_DIFFUSE, light_diffuse2);
    glLightfv(GL_LIGHT2, GL_SPECULAR, light_specular2);
    LightPos2[0] = 1.0;    LightPos2[1] = 0.0;
    LightPos2[2] =  0.6;    LightPos2[3] = 1.0;
  ...
  //  glTranslatef(-XCamera - LA,-YCamera - LB, -ZCamera - LC );
    ...
    if (InteractionMode == MY_MENU_LIGHT) {
        ...
        if ((KeybModifiers & GLUT_ACTIVE_SHIFT) == 0) {
          ...
          //  LightPos[1] = LightPos[1] + smallx ;
	    LightPos[2] = LightPos[1] - smallz ;
	    LightPos1[2] = LightPos1[1] - smallz/10 ;
            LightPos2[2] = LightPos2[1] - smallz/5 ;
    glLightfv(GL_LIGHT0, GL_POSITION, LightPos);
    glLightfv(GL_LIGHT1, GL_POSITION, LightPos1);
    glLightfv(GL_LIGHT2, GL_POSITION, LightPos2);	
