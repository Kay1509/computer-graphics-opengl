...
static GLuint  TextureName,TextureName1;
static GLboolean TextureOn = GL_TRUE;

static TexMap  TMap,TMap1;   /* global for texture from readppm */
...
void myDisplay(void) {
   ...
   //  myDrawTeapot(0.8);
     myDrawCube();
    glPopMatrix();    
      if (InteractionMode == MY_MENU_PROJECT) {
